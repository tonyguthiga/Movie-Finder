...
import static com.moringaschool.moviefinder.R.layout.activity_movies;
...
public class MoviesActivity extends AppCompatActivity {
    ...
    private String[] genres = new String[] {"Superhero", "Comedy",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationTextView.setText("Here are all the movies available: " + location);
    }
}